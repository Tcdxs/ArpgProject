...
#include "ArpgProject/PlayerCharacter/PlayerComponent/ActionData/PrimaryActionData.h"
#include "UObject/Interface.h"

#include "I_DataTransfer.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class UI_DataTransfer : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class ARPGPROJECT_API II_DataTransfer
{
	GENERATED_BODY()
